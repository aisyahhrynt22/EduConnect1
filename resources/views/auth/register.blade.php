                                    ...
                                    <x-auth-card>
                                        ...
                                        <div id="signin-form" class="login-form animated preFadeInLeft fadeInLeft">
                                            ...
                                            <div class="field pb-10">
                                                <div class="control has-icons-right" for="name" :value="__('Name')">
                                                    <input class="input is-medium has-shadow" id="name" type="text" name="name" placeholder="Nama" :value="old('name')" required autofocus />
                                            ...
                                            <div class="field pb-10">
                                                <div class="control has-icons-right" for="email" :value="__('Email')">
                                                    <input class="input is-medium has-shadow" id="email" type="email" name="email" placeholder="Email" :value="old('email')" required />
                                                    <span class="icon is-medium is-right">
                                            ...
                                            <div class="field pb-10">
                                                <div class="control has-icons-right" for="password" :value="__('Password')">
                                                    <input class="input is-medium has-shadow" id="password" type="password" name="password" placeholder="Password" required autocomplete="new-password"/>
                                                    <span class="icon is-medium is-right">
                                            ...
                                            <!-- Input -->
                                            <div class="field pb-10">
                                                <div class="control has-icons-right" for="password_confirmation" :value="__('Confirm Password')">
                                                    <input class="input is-medium has-shadow" id="password_confirmation" type="password"  placeholder="Confirm Password" name="password_confirmation" required />
                                                    <span class="icon is-medium is-right">
                                                    <i data-feather="lock">lock</i>
                                                    </span>
                                                </div>
                                ...
                                >
                                    ...
                                    <div class="argument">
                                        ...
                                        <div class="argument-text light-text">
                                            Sudah punya akun agen silahkan pilih pendaftaran, <a href=/login style="color: black;">Klik disini</a>
                                        </div>
                                    </div>
                                    <!-- Icon block -->
                                    <div class="argument">
