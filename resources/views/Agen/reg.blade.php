...
<html lang="en">
    <head>
        ...
        <title>Registrasi Agen MGM</title>
                        ...
                        <!-- <div class="flex-card light-bordered light-raised">
                            <div class="card-body"> -->
                                <div class="auth-content has-text-centered">
                                    <h3 class="title is-3 is-styled">Create Agent Account </h3>
                                ...
                                <form id="signupform">
                                    ...
                                    <div class="columns pt-8">
                                        <div class="column" style="display: flex;">
                                            <div class="field">
                                                <div class="control">
                                                    <label>Email <span style='font-size:12px;'></span> </label>
                    ...
                    <div class="section-title has-text-centered" style="margin-top: 110px;">
                        ...
                        >
                            <h2 class="subtitle is-light is-4 has-text-left">
                                <i class="im im-icon-Information"></i> Become a Partnership With Us
                            </h2>
                        </div>
                    </div>
                </div>
